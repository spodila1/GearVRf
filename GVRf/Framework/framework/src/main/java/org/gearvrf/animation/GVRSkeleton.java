...
.     * @see #getBoneName
    ...
    /**
     * Get the scene object representing a given bone in the hierarchy.
     * <p>
     * A skeleton can exist independently of a scene graph hierarchy.
     * If the skeleton is imported as part of a model using the
     * {@link org.gearvrf.GVRAssetLoader}, each bone of the skeleton
     * will be associated with a {@GVRSceneObject} of the same name.
     * When a skeleton is attached to a scene object, that object
     * is considered the root of a hierarchy of bones. The
     * hierarchy is examined and scene objects with the same names
     * as skeleton bones are linked together.
     * @param boneindex index of bone to get scene object for
     * @returns scene object associated with a bone, null if none
     */
    ...
    /**
     * Set the scene object representing a given bone in the hierarchy.
     * <p>
     * A skeleton can exist independently of a scene graph hierarchy.
     * If the skeleton is imported as part of a model using the
     * {@link org.gearvrf.GVRAssetLoader}, each bone of the skeleton
     ...
     * hierarchy is examined and scene objects with the same names
     * as skeleton bones are linked together.
     * You can also programatically set the bones using this function.
     * @param boneindex index of bone to set
     * @param bone      scene object to associate with this bone
     */
